...
Officer: 3721950
CaseNum: 101-1-59376804-3721950
...
a rectangle with a Medium Purple outline around her. Make sure you include her cigarette
and feather too.
...
function draw()
{
    ...
    //lina with spring green outline
    stroke(0, 255, 127);
    rect(1197,400,165,330);
    
    
    
    //woman with cigarette medium purple outline
    stroke(147, 112, 219);
    rect(349,601,330,555);
